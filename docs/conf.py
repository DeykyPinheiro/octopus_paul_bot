...
htmlhelp_basename = 'octopus_paul_botdoc'
...
man_pages = [
    ('index', 'octopus_paul_bot', u'project_name Documentation',
...
texinfo_documents = [
    ('index', 'octopus_paul_bot', u'project_name Documentation',
     ...
     'a bot that analyzes a time series of assets and returns the action on the day and inserts the result into the database', 'Miscellaneous'),
]
